...
const DISC_CATS = [
  { key:'bestFit',   label:'⭐ Strongest match', color:T.accent, dimColor:T.accentDim },
  { key:'lowBudget', label:'💸 Low-cost bet',    color:T.blue,   dimColor:T.blueDim   },
  { key:'solo',      label:'🧍 Good solo test',  color:T.amber,  dimColor:T.amberDim  },
  ...
  return (
    <div style={{ marginTop:48 }}>
      ...
      <p style={{ fontSize:'0.92rem', color:T.textMut, marginBottom:18, lineHeight:1.55 }}>
        These are more niche, seasonal, or gear-specific, so they stay off the main list. Still, one of them might be exactly your kind of odd.
      </p>
  ...
  return (
    <div style={{ width:'100%', maxWidth:660, margin:'0 auto', padding:'40px 16px 80px', position:'relative', zIndex:1 }}>
      ...
      <h2 style={{ fontSize:'clamp(1.8rem, 5vw, 2.6rem)', fontWeight:800, letterSpacing:'-0.02em', color:T.textPri, marginBottom:6 }}>
        Your shortlist starts<br/>with a few experiments.
      </h2>
      <p style={{ fontSize:'1rem', color:T.textMut, marginBottom: personalised ? 20 : 28 }}>Pick one that makes you a little curious. This is not a verdict, just a smarter first try.</p>
