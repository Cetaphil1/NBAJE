      ...
      <div className="modal-panel">
        ...
        <div className="modal-sections">
          {[
            ...
            ['The social proof notes', "The notes on each card are realistic takes, not testimonials. They're written to reflect what beginners tend to find surprising, encouraging, or sticky about each activity."],
          ].map(([title, body]) => (
