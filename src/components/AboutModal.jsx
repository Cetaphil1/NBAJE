      ...
      <div className="modal-panel">
        ...
        <div className="modal-sections">
          {[
            ...
            ['The beginner reads', "The notes on each card are not testimonials. They're written as realistic beginner observations: what feels awkward, what removes friction, and why people come back."],
          ].map(([title, body]) => (
