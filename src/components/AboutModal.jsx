      ...
      <div className="modal-panel">
        ...
        <div className="modal-sections">
          {[
            ...
            ['The beginner notes', "The notes on each card are realistic takes, not testimonials. They're written to reflect what beginners often find surprising, awkward, or encouraging about each activity."],
          ].map(([title, body]) => (
