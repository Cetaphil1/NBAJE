      ...
      <div className="modal-panel">
        ...
        <div className="modal-sections">
          {[
            ...
            ['The beginner notes', "The note on each card is written copy, not a testimonial. It points out what beginners usually find approachable, surprising, or worth coming back for."],
          ].map(([title, body]) => (
