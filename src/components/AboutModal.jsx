      ...
      <div className="modal-panel">
        ...
        <div className="modal-sections">
          {[
            ...
            ['The social proof notes', "The notes on each card are realistic takes, not testimonials. They're written to reflect what beginners actually find surprising or encouraging about each activity."],
          ].map(([title, body]) => (
