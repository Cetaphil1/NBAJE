      ...
      <div style={{ padding:'16px 20px 20px', display:'flex', flexDirection:'column', gap:12 }}>
        ...
        {meta.socialProof && (
          <div style={{ display:'flex', flexDirection:'column', gap:4 }}>
            <p style={{ fontSize:'0.68rem', fontWeight:700, textTransform:'uppercase', letterSpacing:'0.1em', color:cat.color }}>Why it clicks</p>
            <p style={{ fontSize:'0.84rem', color:T.textMut, lineHeight:1.5 }}>{meta.socialProof}</p>
          </div>
        )}
        {meta.actionBridge && (
