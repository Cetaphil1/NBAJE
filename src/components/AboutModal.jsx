      ...
      <div className="modal-panel">
        ...
        <div className="modal-sections">
          {[
            ...
            ['The social proof notes', "The card notes are realistic takes, not testimonials. They're written to reflect what beginners often find surprising, sticky, or encouraging about each activity."],
          ].map(([title, body]) => (
