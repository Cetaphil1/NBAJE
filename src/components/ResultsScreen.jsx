...
const DISC_CATS = [
  ...
  { key:'lowBudget', label:'💸 Low-lift start',  color:T.blue,   dimColor:T.blueDim   },
  ...
  return (
    <div style={{ marginTop:48 }}>
      ...
      <p style={{ fontSize:'0.92rem', color:T.textMut, marginBottom:18, lineHeight:1.55 }}>
        Not default quiz picks, still very real rabbit holes. Worth a look if one catches your eye.
      </p>
  ...
  return (
    <div style={{ width:'100%', maxWidth:660, margin:'0 auto', padding:'40px 16px 80px', position:'relative', zIndex:1 }}>
      ...
      <h2 style={{ fontSize:'clamp(1.8rem, 5vw, 2.6rem)', fontWeight:800, letterSpacing:'-0.02em', color:T.textPri, marginBottom:6 }}>
        A few good doors<br/>to open.
      </h2>
      <p style={{ fontSize:'1rem', color:T.textMut, marginBottom: personalised ? 20 : 28 }}>Pick one small experiment. You are not choosing a personality, just a next move.</p>
